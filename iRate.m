...
{	
    NSLog(@"iRate: eventCount = %d (eventsUntilPrompt=%d)", self.eventCount, eventsUntilPrompt);
	...
	{
        NSLog(@"iRate: user has already rated this version");
		return NO;
	}
...
{
    NSLog(@"opening ratings url: %@", self.ratingsURL);
