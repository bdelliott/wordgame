...
- (void)saveLastPlayed:(int)numGuesses {
    // save date of the last word played.  called after a game is completed, either by giving
    // up or solving the word
    
    NSUserDefaults *standardUserDefaults = [NSUserDefaults standardUserDefaults];
    [standardUserDefaults setObject:self.wordDate forKey:@"lastPlayed"];
